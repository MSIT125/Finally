...
namespace WebIndexHotel.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult EditUserInfo(string id)
        {
            ...
            id = User.Identity.GetUserId(); //抓取目前登入帳號的ID
            //Console.Write(id);
            appUser = UserManager.FindById(id); //用ID抓出該帳戶的資料
            //Console.Write(appUser);
        ...
        [HttpPost]
        public async Task<ActionResult> EditUserInfo(UserEdit model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
            ...
            await manager.UpdateAsync(currentUser); //更新修改
